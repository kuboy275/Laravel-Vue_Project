...
export default {
  ...
  methods: {
    ...
    addCustomer() {
      this.$store.dispatch("postApiContact", this.form);
      alert("Thank you ,  The system will contact you as soon as possible");
...
.form-control.is-valid {
  background-image: url(/photos/inventory/valid.jpg);
}
.form-control.is-invalid {
  background-image: url(/photos/inventory/x-valid.png);
}
.invalid-feedback {
  color: #0988ff;
  padding-left: 10px;
