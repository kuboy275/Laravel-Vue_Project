<template>
    <div>
            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-lg-3 items">
                        <div class="fea-content text-right">
                            <div class="fea-content__item">
                                <div class="icon-fea_content">
                                    <font-awesome-icon
                                        :icon="['fas', 'car-side']"
                                        class="icon_content"
                                    />
                                ...
                                <p>
                                    ...
                                    adipisicing elit. Amet provident mollitia
                                    laboriosam totam debitis iusto
                                </p>
                            </div>
                            <div class="fea-content__item">
                                <div class="icon-fea_content">
                    ...
                    <div class="col-lg-6 mt-5 d-flex align-items-center">
                        <img
                            src="http://127.1:8000/storage/home/icon-boxes-img.jpg"
                            width="100%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-3 items">
                        <div class="fea-content text-left">
                            <div class="fea-content__item">
                                <div class="icon-fea_content">
                                    <font-awesome-icon
            ...
            <div class="container">
                <div class="row services-items">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 item">
                        ...
                        <h2>Dealership Provider</h2>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Consequuntur sit nisi error nostrum quia!
                            Fugiat modi quo
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 item">
        ...
        <div class="faq">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 item">
                        <h1>Keep Up On Our Always Evolving Products</h1>
                        <div class="text">
                            <font-awesome-icon
                                :icon="['far', 'bell']"
                                class="icon_item"
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Nisi natus labore tenetur
                                vitae, nemo provident iure ipsa quas facere
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 item">
                        <div class="item_toggle">
                            <b-button v-b-toggle.tab-1 class="btn_toggle">
                                <font-awesome-icon
                                    :icon="['fas', 'plus']"
                                    class="icon_toggle"
                                />
                            ...
                            <b-collapse id="tab-1" accordion="my-group" visible>
                                <b-card-body class="text-white text_toggle">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Quaerat eum velit modi
                                    repellat vero voluptate porro ad
                                </b-card-body>
                            </b-collapse>
                        </div>
                        <div class="item_toggle">
                            <b-button v-b-toggle.tab-2 class="btn_toggle">
                                <font-awesome-icon
                                    :icon="['fas', 'plus']"
                                    class="icon_toggle"
                                />
                                Looking Best Car Services ?
                            </b-button>
                            <b-collapse id="tab-2" accordion="my-group">
                                <b-card-body class="text-white text_toggle">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Consequuntur, adipisci
                                    repellendus voluptatibus voluptatem
                                    necessitatibus, quia non eveniet, aliquam
                                    quam ratione deleni
                                </b-card-body>
                            </b-collapse>
                        </div>
                        <div class="item_toggle">
                            <b-button v-b-toggle.tab-3 class="btn_toggle">
                                <font-awesome-icon
                                    :icon="['fas', 'plus']"
                                    class="icon_toggle"
                                />
                            ...
                            <b-collapse id="tab-3" accordion="my-group">
                                <b-card-body class="text-white text_toggle">
                                    Lorem ipsum dolor sit amet consectetur,
                                    adipisicing elit. Impedit, vitae! Possimus
                                    quisquam voluptatem, qui alias omnis id
                                    nihil molestiae laboriosam eligendi quod
                                    nemo consequuntur
                                </b-card-body>
                            </b-collapse>
                        </div>
        ...
        <!-- END CUSTOMER MAIN HOME -->
        <!-- ************************************** -->
        <!-- START BRANDS MAIN HOME -->
        <div class="brands py-5">
            <div class="container px-5">
                <div class="row align-items-center text-center">
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo1.png"
                            width="80%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo2.png"
                            width="80%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo3.png"
                            width="80%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo4.png"
                            width="80%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo5.png"
                            width="80%"
                            alt=""
                        />
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <img
                            src="http://127.1:8000/storage/home/client-logo6.png"
                            width="80%"
                            alt=""
                        />
                    </div>
        ...
        <!-- END BRANDS MAIN HOME -->
        <!-- ************************************** -->
        <!-- START BLOG MAIN HOME -->
        <div class="blog">
            <div class="container">
                <div class="cta">
                ...
                <div class="title">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-12 col-12">
                            <p>
                                Lorem ipsum dolor sit, amet consectetur
                                adipisicing elit. Earum unde laudantium aut
                                provident minima, ipsam molestiae beatae
                                incidunt
                            </p>
                        </div>
                    </div>
                ...
                <div class="slider ">
                    ...
                    >
                        <slide class="item-slider">
                            <div class="col-12">
                                <img
                                    src="http://127.1:8000/storage/home/blog-thumb1.jpg"
                                    alt=""
                                    width="100%"
                                />
                                <div class="heart">
                                ...
                                <div class="content bg-white p-4">
                                    <div
                                        class="comments d-flex align-items-center"
                                    >
                                        <div
                                        ...
                                        <div
                                            class="cmt d-flex align-items-center"
                                        >
                                            <font-awesome-icon
                                                :icon="['far', 'calendar-alt']"
                                                class="icon"
...
.features .items:nth-child(1) .fea-content .fea-content__item {
    display: flex;
    flex-direction: column;
    align-items: flex-end;
}
.features .fea-content .fea-content__item {
    margin: 35px 0;
}
.features .fea-content .fea-content__item .icon-fea_content {
    width: 60px;
    height: 60px;
...
.features .fea-content .fea-content__item .icon-fea_content .icon_content {
    color: white;
    font-size: 30px;
}
.features .fea-content .fea-content__item h3 {
    font-size: 22px;
    letter-spacing: -1px;
    color: #232628;
    font-weight: 700;
...
.features .fea-content .fea-content__item p {
    font-size: 14px;
    line-height: 32px;
    color: #888888;
    font-weight: 400;
...
@media (max-width: 991px) {
    ...
    .features .items:nth-child(1) .fea-content {
...
.services .services-items .item h2 {
    font-size: 24px;
    letter-spacing: -1px;
    margin-top: 20px;
    color: #232628;
...
.faq .item .item_toggle .btn_toggle {
    background: none;
    border-radius: 0;
    border: none;
    box-shadow: none;
...
.faq .item .item_toggle .btn_toggle .icon_toggle {
    margin-right: 10px;
}
.faq .item .item_toggle .text_toggle {
    font-size: 14px;
    line-height: 28px;
    color: #ffffff;
    font-weight: 400;
